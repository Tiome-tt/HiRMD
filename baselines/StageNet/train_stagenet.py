...
from stagenet import StageNet_Fusion  # <--- 引入 StageNet
...
def main():
    ...
    print(f"Data loaded successfully! Starting {len(seeds)} StageNet runs on {device}...")
    ...
    for run_idx, current_seed in enumerate(seeds):
        ...
        # 模型保存路径修改为 stagenet
        best_model_path = f"/home/user1/MXY/TimeAttention/baselines/stagenet_best_model_seed_{current_seed}.pth"

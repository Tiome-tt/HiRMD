...
def plot_all_histories_combined(all_collected_histories):
    ...
    fig.suptitle('Robustness Evaluation: All 25 Folds Training History', fontsize=18, y=1.0)
...
gpt_response_file = f"HiRMD/TimeAttention/LLM_medical_diagnosis/outputs/LLM_Diagnosis_{datasets}_2.jsonl"
...
print(f"========== Starting Evaluation over {len(seeds)} Seeds ==========\n")
...
print("             FINAL ROBUSTNESS EVALUATION RESULTS             ")
print("=" * 60)
